...
currentBrainID(25284).
objectIndex(aI_CommanderActuator,25284).
aI_CommanderSensor_baseHealthPercentage(aI_Commander,objectIndex(25284),100).
aI_CommanderSensor_baseHealth(aI_Commander,objectIndex(25284),500).
aI_CommanderSensor_maxUnitCount(aI_Commander,objectIndex(25284),10).
aI_CommanderSensor_currentUnitCount(aI_Commander,objectIndex(25284),7).
aI_CommanderSensor_numMessagesInDispatcher(aI_Commander,objectIndex(25284),0).
aI_CommanderSensor_currentMoney(aI_Commander,objectIndex(25284),2025).
