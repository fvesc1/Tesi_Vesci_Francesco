...
%conscriptSensor_myUnitId(friendlyConscript,objectIndex(Index),Value).
%conscriptSensor_isBackupRequested(friendlyConscript,objectIndex(Index),Value).
%conscriptSensor_amILowHealth(friendlyConscript,objectIndex(Index),Value).
%conscriptSensor_isAttackOrderPresent(friendlyConscript,objectIndex(Index),Value).
%conscriptSensor_currentGlobalObjectiveId(friendlyConscript,objectIndex(Index),Value).
%Actuators:
...
setOnActuator(conscriptActuator_aspTargetObjectiveId(friendlyConscript,objectIndex(Index),Value)) :-objectIndex(conscriptActuator, Index), .
