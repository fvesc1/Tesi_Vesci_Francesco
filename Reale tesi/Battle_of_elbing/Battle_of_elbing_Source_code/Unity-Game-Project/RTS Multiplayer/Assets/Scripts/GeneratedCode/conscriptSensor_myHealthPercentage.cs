...
{
	public class conscriptSensor_myHealthPercentage : Sensor
	{
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "conscriptSensor_myHealthPercentage(friendlyConscript,objectIndex("+index+"),{0})." + Environment.NewLine;
		}
