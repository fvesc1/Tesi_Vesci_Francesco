...
{
	public class sniperSensor_myHealthPercentage : Sensor
	{
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "sniperSensor_myHealthPercentage(friendlySniper,objectIndex("+index+"),{0})." + Environment.NewLine;
		}
