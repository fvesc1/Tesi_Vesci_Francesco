...
{
	public class conscriptSensor_visibleEnemiesCount : Sensor
	{
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "conscriptSensor_visibleEnemiesCount(friendlyConscript,objectIndex("+index+"),{0})." + Environment.NewLine;
		}
