...
{
	public class friendlyConscript2Sensor_myHealthPercentage : Sensor
	{
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "friendlyConscript2Sensor_myHealthPercentage(friendlyConscript2,objectIndex("+index+"),{0})." + Environment.NewLine;
		}
