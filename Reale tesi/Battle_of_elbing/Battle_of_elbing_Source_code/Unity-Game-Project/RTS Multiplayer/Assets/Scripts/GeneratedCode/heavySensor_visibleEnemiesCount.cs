...
{
	public class heavySensor_visibleEnemiesCount : Sensor
	{
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "heavySensor_visibleEnemiesCount(friendlyHeavy,objectIndex("+index+"),{0})." + Environment.NewLine;
		}
